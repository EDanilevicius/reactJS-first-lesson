      ...
      <div className="App">
        <header className="Header">
          ...
          <p className="Header--summary">
            Bacon ipsum dolor amet turkey ham porchetta alcatra boudin,
            prosciutto doner beef ribs. Pork chop fatback ground round, corned
            beef drumstick brisket tri-tip bresaola ham biltong short ribs jowl
            kielbasa pork loin chicken. Strip steak kielbasa t-bone burgdoggen
            fatback swine spare ribs meatball landjaeger pork belly tri-tip
            short loin. Chuck turducken chicken tenderloin bresaola ribeye, pork
            chop burgdoggen hamburger landjaeger pastrami sirloin flank ground
            round buffalo. Cow turducken meatloaf capicola pork tongue ham hock
            bresaola tail pig chuck.
          </p>
          <img
